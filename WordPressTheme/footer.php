      ...
      <nav class="p-footer__nav">
        <div class="p-footer__nav-wrap">
          <ul class="p-footer__link">
            <li class="p-footer__item"><a href="<?php echo $outpatient; ?>"><span class="p-footer__circle"></span>外来</a>
            </li>
            <li class="p-footer__item"><a href="<?php echo $department; ?>"><span class="p-footer__circle"></span>診療科・部門</a></li>
            <li class="p-footer__item"><a href="<?php echo $hospitalization; ?>"><span class="p-footer__circle"></span>入院・面会</a></li>
            <li class="p-footer__item"><a href="<?php echo $about; ?>"><span class="p-footer__circle"></span>当院について</a></li>
            <li class="p-footer__item"><a href="<?php echo $checkup; ?>"><span class="p-footer__circle"></span>検診</a></li>
            <li class="p-footer__item"><a href="<?php echo $recruit; ?>"><span class="p-footer__circle"></span>求人情報</a></li>
            <li class="p-footer__privacy u-mobile"><a href="<?php echo $privacy_policy; ?>"><span class="p-footer__circle-gray"></span>プライバシーポリシー</a></li>
          </ul>
