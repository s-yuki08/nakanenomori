        ...
        <table class="p-visit__table">
          ...
          <tbody>
            <tr>
              ...
              <td class="p-visit__time">14:00〜19:00／15分間</td>
            </tr>
            <tr>
              <th scope="row" class="p-visit__label">日曜日・祝日</th>
              <td class="p-visit__time">14:00〜18:00／15分間</td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="p-visit__card-wrapper">
        <div class="p-visit__card-content">
          <p class="p-visit__lead">
            ご面会の際は、受付にてお手続きを<span>お願いいたします。</span>
          </p>
          <div class="p-visit__text">
            <p>
              ご面会できる方は、1親等もしくは兄弟姉妹かつ、<br class="u-desktop">
              12歳以上の方（1回につき2名まで）に限らせていただきます。<br>
              大人数での面会や、お子さま（12歳以下）の面会はお控えください。<br>
        ...
        <div class="p-visit__caution-wrapper">
          <div class="p-visit__caution-content">
            ...
            <ul class="p-visit__list">
              ...
              <li>・長時間の面会は、同室患者様の処置や介助の妨げになるため、15分以内の面会をお願いしております。<br>ご協力をお願いいたします。</li>
              <li>・夜間施錠の妨げになり防犯上の問題が生じるため、面会は時間内厳守をお願いいたします。</li>
              <li>・面会をされる患者様の状態や、院内の状況によっては面会をお断りさせていただく場合があります。予めご了承ください。</li>
              <li>・敷地内/施設内は全面禁煙です。</li>
              <li>・その他、ルールをお守りいただけない場合には、面会をお断りいたします。</li>
            </ul>
          </div>
        </div>
      </div>
